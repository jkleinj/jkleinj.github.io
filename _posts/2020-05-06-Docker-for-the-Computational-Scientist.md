...
Distributing Docker images is also easy: The Docker Hub is free to use for public Docker images the same way GitHub is free for public software repositories.
